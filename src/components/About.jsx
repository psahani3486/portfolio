...
import { FiAward, FiBookOpen, FiCpu, FiCode } from 'react-icons/fi'
...
export default function About() {
  return (
    <section id="about" className="py-24 md:py-32 relative overflow-hidden border-t border-white/[0.04]">
      {/* Background Glow */}
          ...
          <div className="lg:col-span-7">
            <div className="flex flex-col lg:flex-row gap-10 items-start">
              ...
              <div className="flex-1">
                ...
                >
                  Final year B.Tech student in Mathematics &amp; Computing at Netaji Subhas University of Technology (NSUT). Specialized in constructing high-speed anti-hallucination RAG pipelines, predictive machine learning engines, autonomous data observability frameworks, and modern enterprise full-stack web applications.
                </motion.p>
              </div>
            </div>
          </div>
